    ...
    <form class="container mt-4" action="/system/account/add" method="post">
        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-12 col-md-4 d-flex flex-column align-items-center">
                <img src="{{ asset(Auth::user()->usr_photo_path ?? '/logo/user_placeholder.jpg') }}" class="rounded-circle shadow object-fit-cover mb-2" alt="Profile Image" width="200" height="200">
            </div>
            @error('image')
            ...
            <div class="col-12 col-md-8">
                ...
                <div class="d-flex justify-content-center mt-5">
                    <button type="submit" class="btn btn-outline-primary w-100" onclick="this.disabled=true; this.form.submit();">Kirim</button>
                </div>
