<x-app-layout>
    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-12 col-md-8">
        <div class="mb-3">
          ...
          <input type="text" id="nama" class="form-control  shadow object-fit-cover" autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="whatsapp" class="form-label">No WhatsApp</label>
          <input type="text" id="whatsapp" class="form-control  shadow object-fit-cover ">
        </div>

        <div class="mb-3">
          <label for="password" class="form-label">Password</label>
          <input type="password" id="password" class="form-control  shadow object-fit-cover " autocomplete="off">
        </div>
  ...
  <select class="form-select  shadow object-fit-cover " aria-label="Default select example">
