    ...
    <x-table_data :paginator="$returns">
        ...
        @forelse ($returns as $index => $return)
            <tr class="align-middle">
                ...
                @php
                    $dueDate = $return->trx_due_date ? \Carbon\Carbon::parse($return->trx_due_date) : null;
                @endphp
                ...
                <td>
                    <a href="/manage/transaction/{{ $return->trx_id }}/detail" class="btn btn-warning m-0"><i class="bi bi-list-ul"></i></a>
                </td>
            </tr>
        @empty
            <tr>
