<nav class="app-header navbar navbar-expand" style="background-color: #121740;">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            @endif --}}
            @if (auth()->user()?->usr_activation ?? '0' == '1')
                <li class="nav-item">
            ...
            <li class="nav-item d-none d-md-block">
                <a href="{{ url()->previous() }}" class="nav-link d-flex align-items-center justify-content-center" style="padding: 0.5rem; height: 40px; width: 40px;">
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    <img src="{{ asset(Auth::user()->usr_card_url ?? '/logo/user_placeholder.jpg') }}" class="user-image rounded-circle shadow object-fit-cover" alt="" />
                </a>
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    <!--begin::User Image-->
                    <li class="user-header" style="background-color: #121740;">
                        <img src="{{ asset(Auth::user()->usr_card_url ?? '/logo/user_placeholder.jpg') }}" class="rounded-circle shadow object-fit-cover" alt="" />
