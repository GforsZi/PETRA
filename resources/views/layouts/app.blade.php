                                            ...
                                            <div class="offcanvas-body">
                                                ...
                                                <main class="chat-card">
                                                    <header class="chat-header">
                                                        <div class="avatar"><i class='bx bxs-robot'
                                                                style='color:#f3fdfc'></i></div>
                                                        <div class="title">
                                                            <h4>ChatBot — PETRA</h4>
                                                        </div>
                                                        <div
                                                    ...
                                                    <div class="chat-footer">
                                                        <button type="button"id="toggleQuickBtn"
                                                            class="btn btn-success">opsi</button>
                                                    ...
                                                    <div class="quick-messages" id="quickPanel">
                                                        <button class="quick-item"
                                                            data-msg="Halo ">Halo </button>
                                                        <button class="quick-item"
                                                            data-msg="Apa kabar?">Apa
                                                            kabar?</button>
                                                        <button class="quick-item"
                                                            data-msg="Saya butuh bantuan">Butuh
                                                            bantuan</button>
                                                        <button class="quick-item"
                                                            data-msg="Terima kasih ">Terima kasih
                                                        </button>
                                                        <button class="quick-item"
                                                            data-msg="Selamat pagi ">Selamat pagi
                                                        </button>
                                                        <button class="quick-item"
                                                            data-msg="Selamat malam ">Selamat malam
                                                        </button>
                                                        <button class="quick-item"
                                                            data-msg="Saya tertarik">Saya
                                                            tertarik</button>
                                                        <button class="quick-item"
                                                            data-msg="Boleh info lebih lanjut?">Info
                                                            lanjut</button>
                                                    </div>
