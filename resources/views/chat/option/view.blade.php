                    ...
                    <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu ">
                            <li><a class="dropdown-item"
                                    href="/manage/chat/option/{{ $option->cht_opt_id }}/detail">Detail</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="/manage/chat/option/{{ $option->cht_opt_id }}/edit">Ubah</a>
                            </li>
                            <li><a class="dropdown-item" style="cursor: pointer;"
                                    data-bs-toggle="modal"
                                    data-bs-target="#deleteConfirmation{{ $options->firstItem() + $index }}">Hapus</a>
                            </li>
                        </ul>
                    </div>
                    <div class="modal fade"
                        id="deleteConfirmation{{ $options->firstItem() + $index }}"
                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="deleteConfirmation{{ $options->firstItem() + $index }}Label"
                        aria-hidden="true">
                        <form action="/system/option/{{ $option->cht_opt_id }}/delete"
