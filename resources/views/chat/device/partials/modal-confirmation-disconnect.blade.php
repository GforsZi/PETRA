...
<div class="modal fade" id="confirmDisconnectModal" tabindex="-1" aria-labelledby="confirmDisconnectLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="closeConfirmDisconnectModal()"></button>
            </div>
