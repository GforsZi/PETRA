            ...
            <div class="card-body">
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus"
                        data-bs-title="Pemberitahuan" data-bs-content="Memilih jurusan akan membuat buku ini dimasukan dalam kategori buku paket pembelajaran">Tingkatan
                        Kelas</label>
                    <div class="col-sm-10">
                        <input type="text" name="bk_mjr_class" value="{{ $major['bk_mjr_class'] }}" class="form-control @error('bk_mjr_class') is-invalid @enderror" id="inputEmail3">
                        @error('bk_mjr_class')
                ...
                <div class="row mb-3">
                    <label for="inputEmail3" class="col-sm-2 col-form-label" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-trigger="hover focus"
                        data-bs-title="Pemberitahuan" data-bs-content="Memilih jurusan akan membuat buku ini dimasukan dalam kategori buku paket pembelajaran">Jurusan
                        Kelas
                        Klasifikasi</label>
                    <div class="col-sm-10">
