        ...
        <x-slot:title>
            <form class="d-flex" role="search" method="get" action="/manage/book/author">
                <input class="form-control me-2" name="s" type="search"
                    placeholder="Masukan Nama Penulis" aria-label="Search" />
                ...
                <td>
                    <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu ">
                            ...
                            <li><a class="dropdown-item"
                                    href="/manage/book/author/{{ $author->athr_id }}/edit">Ubah</a>
                            </li>
                            <li><a class="dropdown-item" style="cursor: pointer;"
                                    data-bs-toggle="modal"
                                    data-bs-target="#deleteConfirmation{{ $authors->firstItem() + $index }}">Hapus</a>
                            </li>
                        </ul>
                    </div>
                    <div class="modal fade"
                        id="deleteConfirmation{{ $authors->firstItem() + $index }}"
                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="deleteConfirmation{{ $authors->firstItem() + $index }}Label"
                        aria-hidden="true">
                        <form action="/system/author/{{ $author->athr_id }}/delete" method="post"
