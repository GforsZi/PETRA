        ...
        @forelse ($classfications as $index => $classfication)
            <tr class="align-middle">
                ...
                <td>
                    ...
                    <div class="modal fade" id="deleteConfirmation{{ $classfications->firstItem() + $index }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                        aria-labelledby="deleteConfirmation{{ $classfications->firstItem() + $index }}Label" aria-hidden="true">
                        <form action="/system/ddc/{{ $classfication->ddc_id }}/delete" method="post" class="modal-dialog modal-dialog-centered">
                            @csrf
                            @method('DELETE')
