...
Route::middleware('auth')
    ...
    ->group(function () {
        ...
        Route::get('/manage/book/{id}/detail/print_label', [ManageBookController::class, 'print_label_system'])->name('labels.print');
        ...
        Route::get('/manage/major', [ManageBookController::class, 'manage_book_major_page']);
        Route::get('/manage/major/{id}/detail', [ManageBookController::class, 'detail_book_major_page']);
        Route::get('/manage/major/add', [ManageBookController::class, 'add_book_major_page']);
        Route::get('/manage/major/{id}/edit', [ManageBookController::class, 'edit_book_major_page']);
        Route::get('/manage/ddc', [ManageBookController::class, 'manage_book_classfication_page']);
        Route::get('/manage/ddc/add', [ManageBookController::class, 'add_book_classfication_page']);
        Route::get('/manage/ddc/{id}/detail', [ManageBookController::class, 'detail_book_classfication_page']);
        Route::get('/manage/ddc/{id}/edit', [ManageBookController::class, 'edit_book_classfication_page']);
        Route::get('/manage/origin', [ManageBookController::class, 'manage_book_origin_page']);
        Route::get('/manage/origin/add', [ManageBookController::class, 'add_book_origin_page']);
        Route::get('/manage/origin/{id}/detail', [ManageBookController::class, 'detail_book_origin_page']);
        Route::get('/manage/origin/{id}/edit', [ManageBookController::class, 'edit_book_origin_page']);
        Route::get('/manage/author', [ManageBookController::class, 'manage_book_author_page']);
        Route::get('/manage/author/{id}/detail', [ManageBookController::class, 'detail_book_author_page']);
        Route::get('/manage/author/add', [ManageBookController::class, 'add_book_author_page']);
        Route::get('/manage/author/{id}/edit', [ManageBookController::class, 'edit_book_author_page']);
        Route::get('/manage/publisher', [ManageBookController::class, 'manage_book_publisher_page']);
        Route::get('/manage/publisher/add', [ManageBookController::class, 'add_book_publisher_page']);
        Route::get('/manage/publisher/{id}/edit', [ManageBookController::class, 'edit_book_publisher_page']);
        Route::get('/manage/publisher/{id}/detail', [ManageBookController::class, 'detail_book_publisher_page']);
...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/system/option/{id}/delete', [ManageChatbotController::class, 'delete_chatbot_option_system'])
        ->middleware(CheckActivation::class . ':1')
        ->middleware(CheckAdmin::class . ':1');
    Route::get('/system/option/chat/quick_replies', [ManageChatbotController::class, 'show_quick_reply_system'])->middleware(CheckActivation::class . ':1');
    Route::post('/system/option/chat/reply', [ManageChatbotController::class, 'reply_system'])->middleware(CheckActivation::class . ':1');
    ...
    Route::delete('/system/transaction/{id}/delete', [ManageTransactionController::class, 'delete_transaction_system'])
        ->middleware(CheckActivation::class . ':1')
        ->middleware(CheckAdmin::class . ':1');
    Route::post('/system/transaction/{id}/send_message', [ManageTransactionController::class, 'send_message_transaction'])
        ->middleware(CheckActivation::class . ':1')
        ->middleware(CheckAdmin::class . ':1');
