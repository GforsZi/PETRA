        ...
        addSidebarBreakPoint() {
            ...
            ;((this._config = Object.assign(Object.assign({}, this._config), {
                ...
                window.innerWidth <= this._config.sidebarBreakpoint
                    ? this.collapse()
                    : (document.body.classList.contains(d) || this.expand(), document.body.classList.contains(d) && document.body.classList.contains(m) && this.collapse()))
        }
        toggle() {
    ...
    class U {
        ...
        collapse() {
            ...
            ;(this._parent &&
                ...
                (null === (e = this._parent) || void 0 === e ? void 0 : e.querySelectorAll(`${K}, ${Q}`)).forEach((e) => {
            ...
            ;(this._parent &&
                ...
                setTimeout(() => {
                    ...
                    ;(t && t.classList.remove(N),
                        this._parent && (this._parent.classList.remove(N), (null === (e = this._parent) || void 0 === e ? void 0 : e.classList.contains(W)) && this._parent.classList.remove(W)))
                }, 10)),
                null === (e = this._element) || void 0 === e || e.dispatchEvent(t))
        }
        toggleMaximize() {
